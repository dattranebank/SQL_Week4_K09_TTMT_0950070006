...
Create procedure Cau4_Procedure(@MaHangSanXuat nchar(10), @TenHang nvarchar(20), @DiaChi nvarchar(30), @SoDienThoai nvarchar(20), @Email nvarchar(30))
as
	begin
	if (exists(Select * From T2_HangSanXuat T2 Where T2.TenHang=@TenHang))
		print N'Tên hãng đã tồn tại, mời bạn nhập tên khác'
...
Exec Cau4_Procedure 'H05','Samsung','Korea','011-08271717','ss@gmail.com.kr'
...
Create procedure Cau5_Procedure(@MaHangSanXuat nchar(10), @TenHang nvarchar(20), @DiaChi nvarchar(30), @SoDienThoai nvarchar(20), @Email nvarchar(30))
as
	begin
	if (exists(Select * From T2_HangSanXuat T2 Where T2.TenHang=@TenHang))
		print N'Tên hãng đã tồn tại, mời bạn nhập tên khác'
...
Exec Cau5_Procedure 'H05','Samsung','Korea','011-08271717','ss@gmail.com.kr'
...
Create procedure Cau6_Procedure(@MaHangSanXuat nchar(10), @TenHang nvarchar(20), @DiaChi nvarchar(30), @SoDienThoai nvarchar(20), @Email nvarchar(30))
as
	begin
	if (exists(Select * From T2_HangSanXuat T2 Where T2.TenHang=@TenHang))
		print N'Tên hãng đã tồn tại, mời bạn nhập tên khác'
...
Exec Cau6_Procedure 'H05','Samsung','Korea','011-08271717','ss@gmail.com.kr'
...
Create procedure Cau7_Procedure(@MaHangSanXuat nchar(10), @TenHang nvarchar(20), @DiaChi nvarchar(30), @SoDienThoai nvarchar(20), @Email nvarchar(30))
as
	begin
	if (exists(Select * From T2_HangSanXuat T2 Where T2.TenHang=@TenHang))
		print N'Tên hãng đã tồn tại, mời bạn nhập tên khác'
...
Exec Cau7_Procedure 'H05','Samsung','Korea','011-08271717','ss@gmail.com.kr'
...
Create procedure Cau8_Procedure(@MaHangSanXuat nchar(10), @TenHang nvarchar(20), @DiaChi nvarchar(30), @SoDienThoai nvarchar(20), @Email nvarchar(30))
as
	begin
	if (exists(Select * From T2_HangSanXuat T2 Where T2.TenHang=@TenHang))
		print N'Tên hãng đã tồn tại, mời bạn nhập tên khác'
...
Exec Cau8_Procedure 'H05','Samsung','Korea','011-08271717','ss@gmail.com.kr'
